...
export default function LandlordCTA() {
  return (
    <section className="bg-primary-charcoal">
        ...
        <div className="flex flex-col lg:flex-row items-center gap-8 lg:gap-12">
          ...
          <div className="flex-1 flex flex-col items-end text-right order-1 lg:order-2">
            <div className="space-y-2.5 mb-6">
              <h2 className="text-[28px] sm:text-[32px] font-bold text-surface-beige leading-normal">
                هل لديك مساحة وتريد تأجيرها؟
              </h2>
              <p className="text-[15px] leading-[1.7] text-background-ivory">
